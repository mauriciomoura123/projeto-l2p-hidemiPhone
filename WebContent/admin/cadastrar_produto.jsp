      ...
      <div class="row">
        ...
        <small id="fileHelp" class="form-text text-muted">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nomeProd" class="form-control" value="" placeholder="Nome do produto...">
                </div>
                <div class="form-group">
                  <label for="descricao">Descrição</label>
                  <textarea name="descricaoProd" class="form-control" rows="4" maxlength="1000" style="resize: none;" value="" placeholder="Descrição do produto..."></textarea>
                </div>
                <div class="form-group">
