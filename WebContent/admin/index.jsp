      ...
      <div class="row">
       ...
       <c:forEach items="${prodBean.listaProd }" var="p">
        <tr>
         ...
         <td><img src='imgProdutos/${p.foto }' style="width:120px;"></td>
         <td>${p.nome }</td>
         <td>${p.descricao }</td>
         ...
         <td class="text-center"><a href="excluir?cod=${p.codigo }" onclick="return window.confirm('Deseja realmente excluir esse item?')" class="btn btn-danger"><i
