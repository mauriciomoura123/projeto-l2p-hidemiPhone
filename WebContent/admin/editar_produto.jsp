      ...
      <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-block">
              ...
              <div class="main-img-preview">
                <img class="thumbnail img-mostrar-2" src="imgProdutos/${produto.foto }" title="Imagem Produto">
            </div>
            <hr>
        ...
        <small id="fileHelp" class="form-text text-muted">
                ...
                <div class="form-group">
                  ...
                  <textarea name="descricao" class="form-control" rows="4" maxlength="500" style="resize: none;" placeholder="Descrição do produto...">${produto.descricao }</textarea>
                </div>
                <div class="form-group">
